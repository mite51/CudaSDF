# CUDA UV Atlas Unwrap

---

## Project Summary — Automatic UV Atlas (CUDA / C++)
...
**Goal**: automatic, robust unwrap to a single 0–1 UV atlas
...
### `src/uv_unwrap/common/math_types.h`
...
### `src/uv_unwrap/common/adjacency.h`
...
### `src/uv_unwrap/common/hash_utils.h`
...
### `src/uv_unwrap/common/image_view.h`
...
### `src/uv_unwrap/unwrap/unwrap_config.h`
...
### `src/uv_unwrap/unwrap/unwrap_result.h`
...
### `src/uv_unwrap/unwrap/unwrap_pipeline.h`
...
### `src/uv_unwrap/unwrap/chart_builder.h`
...
### `src/uv_unwrap/unwrap/boundary_loops.h`
...
### `src/uv_unwrap/unwrap/atlas_packer.h`
...
### `src/uv_unwrap/unwrap/uv_postprocess.h`
...
### `src/uv_unwrap/unwrap/unwrap_pipeline.cpp` Flow (Conceptual)
...
#### `src/uv_unwrap/amgx/amgx_context.h`
...
#### `src/uv_unwrap/amgx/amgx_solver.h`
